/* Port-owned copy. Upstream ships this per-example under <example>/<core>/User/
 * rather than in EVT/EXAM/SRC -- it selects which peripheral headers are pulled
 * in, which is per-project configuration. PlatformIO's package puts it in
 * Peripheral/inc, which is where this copy came from.
 */
/********************************** (C) COPYRIGHT *******************************
